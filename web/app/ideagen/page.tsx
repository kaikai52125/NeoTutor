                  ...
                  <div className="p-4 flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2 min-w-0">
                        <h3 className="font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2 min-w-0 truncate">
                          <Zap className="w-4 h-4 text-amber-500 dark:text-amber-400 shrink-0" />
                          <span className="truncate">{idea.knowledge_point}</span>
                        </h3>
                      ...
                      <p className="text-sm text-slate-500 dark:text-slate-400 mt-1 overflow-hidden leading-5" style={{display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', maxHeight: '2.5rem'}}>
                        {idea.description}
                      </p>
